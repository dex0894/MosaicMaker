...
namespace GroupJMosaicMaker.Utility
{
    ...
    public static class ArrayExtensions
    {
        ...
        public static IEnumerable<T> GetRow<T>(this T[,] rectarray, int row)
        {
            ...
            for (var c = 0; c < rectarray.GetLength(1); c++)
            {
        ...
        public static IEnumerable<T> GetColumn<T>(this T[,] rectarray, int column)
        {
            ...
            for (var r = 0; r < rectarray.GetLength(0); r++)
            {
        ...
        ///     An exception will be thrown if the column is out of bounds, and return default in places where there are no
        ///     elements from inner arrays.
        ...
        {
            var inner = new string[mdarray.GetLength(0)];

            for (var r = 0; r < mdarray.GetLength(0); r++)
            {
        ...
        {
            var inner = new string[rectarray.GetLength(0)];
